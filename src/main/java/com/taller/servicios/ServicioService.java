...
public class ServicioService {
        ...
        if ("FIJO".equals(servicio.getTipoPrecio())) {
            ...
            if (servicio.getPrecioSugerido() == null ||
                ...
                throw new RuntimeException(
                        "Los servicios fijos deben tener un precio sugerido mayor a 0");
            }
    ...
    public Servicio actualizar(Long id, Servicio servicioActualizado) {
        ...
        servicio.setNombreServicio(
                servicioActualizado.getNombreServicio());

        servicio.setAreaServicio(
                servicioActualizado.getAreaServicio());

        servicio.setDescripcionServicio(
                servicioActualizado.getDescripcionServicio());

        servicio.setEstadoServicio(
                servicioActualizado.getEstadoServicio());
        ...
        if ("FIJO".equals(servicioActualizado.getTipoPrecio())) {
            ...
            if (servicioActualizado.getPrecioSugerido() == null ||
                    servicioActualizado.getPrecioSugerido()
